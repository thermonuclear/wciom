...
if (isset($_SERVER['KOHANA_ENV']))
{
    ...
    define('ENVIRONMENT', $_SERVER['KOHANA_ENV']);
}
 ...
 */
Cookie::$salt = 'mrRs4jCn1sPH6JVqJNw2nl9sJJsNIYtV2fkZsuXz';
Cookie::$secure = true;
...
Kohana::modules([
	...
	// 'codebench'  => MODPATH.'codebench',  // Benchmarking tool
     ...
     'kohana-qrcode' => MODPATH . 'kohana-qrcode',
...
Route::set('api','api(/<controller>(/<action>(/<id>(/<sid>))))')
    ->defaults(array(
        'directory'  => 'api',
    ));
