...
class Kohana_Cookie {
  ...
  {
    setcookie($name . '-legacy', $value, $expire, $path, $domain, true, true);
    //return setcookie($name, $value, $expire, $path . ';SameSite=None', $domain, true, true); // Временно закомментил для php 7.3.9
